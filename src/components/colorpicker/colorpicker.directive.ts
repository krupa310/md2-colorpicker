...
export class ColorPickerDirective implements OnInit {
    ...
    @Input('cpHeight') cpHeight: string = '220px';
    private dialog: any;
            ...
            this.dcl.loadNextToLocation(DialogComponent, this.vcRef)
                .then((res) => {
                    res.instance.setDialog(this, this.el, this.colorPicker, this.cpPosition, this.cpPositionOffset,
                        this.cpPositionRelativeToArrow, this.cpOutputFormat, this.cpCancelButton, this.cpHeight);
...
@Component({
    ...
    .color-picker {width: 200px;height: 220px;border: #B2B2B2 solid 1px;left: 30px;top: 250px;position: absolute;z-index: 1000;background-color: #fff;-webkit-touch-callout: none;-webkit-user-select: none;-khtml-user-select: none;-moz-user-select: none;-ms-user-select: none;user-select: none;transition-duration: 5s;}
    ...
    .color-picker .color-picker-cancel-btn {position: absolute;bottom: 10px;right: 2%;border-radius: 0;padding: 2px 7px; }
    ...
    .color-picker div.cursor {cursor: default;position: relative;-moz-border-radius: 50%;-webkit-border-radius: 50%;border-radius: 50%;-khtml-border-radius: 50%;width: 16px;height: 16px;border: #222 solid 2px; }
...
export class DialogComponent implements OnInit {
    ...
    private dialogWidth: number = 220;
    ...
    setDialog(instance: any, elementRef: ElementRef, color: any, cpPosition: string, cpPositionOffset: string,
        cpPositionRelativeToArrow: boolean, cpOutputFormat: string, cpCancelButton: boolean) {
    ...
    ngOnInit() {
        ...
        this.sliderDimMax = new SliderDimension(150, 200, 130, 150);
